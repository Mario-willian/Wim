...
else if (isset($_GET['depositar'])){
    $deposito->inserir();
    $cpf = $_GET["usuario_cpf"];
    header("location:carteira.php");
}
?>
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">WIM</span>
</div>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a class="w3-bar-item w3-button w3-padding w3-blue" href="carteira.php"><i class="fa fa-money"></i> Carteira</a>
    <a class="w3-bar-item w3-button w3-padding" href="acompanhar.php"><i class="fa fa-eye fa-fw"></i> Acompanhar</a>
    <a class="w3-bar-item w3-button w3-padding" href="doar.php"><i class="fa fa-handshake-o"></i> Doar Dinheiro</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h2><b><i class="fa fa-money"></i> Inserir Dinheiro</b></h2>

<form action="colocar.php" method="get">


          <div class="col-50">
            <h3 for="fname">Cartões Aceitos</h3>
            <div class="icon-container"><h3>
  ...
  <b><input class="w3-input w3-border" type="text" name="proprietario" placeholder="Digite o nome do proprietário do cartão" required=""><br></b>
	<h3>Número do cartão</h3>
	<b><input class="w3-input w3-border" type="number" name="num_cartao" placeholder="Digite o número do seu cartão" required=""><br></b>
	<h3>Mês Exp</h3>
	<b><input class="w3-input w3-border" type="text" name="mesexp" placeholder="Ex: setembro" required=""><br></b>
	<h3>CVV</h3>
	<b><input class="w3-input w3-border" type="number" name="seguranca" placeholder="Digite o código que se encontra atrás do cartão" maxlength="3" required=""></b>
  ...
  <input class="w3-input w3-border" style="display:none" name="carteira_codigo" type="text" value="<?php echo $row_estoquess['codigo'];?>" >
	<br>
  <h3>Ano de Exp</h3>
  <b><input class="w3-input w3-border" type="number" name="anoexp" placeholder="Ex: 2018" required=""><br></b>
   <h3>Valor</h3>
  <b><input class="w3-input w3-border" type="number" name="valor" placeholder="Ex: 30" required=""><br></b>
  <button type="submit" disabled="" name="depositar" class="btn btn-outline-success w3-block w3-padding-large  w3-margin-bottom"><i class="fa fa-money"></i> Colocar Dinheiro</button></form>
