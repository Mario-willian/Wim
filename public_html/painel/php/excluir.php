...
require_once "exclusao.php";

$exclusao = new Exclusaos();

if (isset($_GET['confirmar'])){
    $exclusao->excluir($_GET["cmd"]);
}
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h2><b><i class="fa fa-trash"></i> Excluir Conta</b></h2>

<center><h2><b style='color: orange'><i class='fa fa-warning'></i> Aviso</b></h2></center>
<h2><b>Ao excluir sua conta você perderá todos os seus dados salvos, incluindo seu dinheiro acumulado. Não será possivel recuperar sua conta!<br><center> Tem certeza que deseja prosseguir?</h2>
  <div class="row">
          <div class="col-md-6 col-xs-6">
            <form action="excluir.php" method="get">
              <input type="" style="display:none" value="<?php echo $row_estoques['cpf'];?>" name="tx">
              <input class="w3-input w3-border" style="display:none" name="cmd" type="text" value="<?php echo $row_estoques['cmd'];?>" >
            <br><button type="submit" name="confirmar"  class="btn btn-outline-success w3-block w3-padding-large  w3-margin-bottom"><i class="fa fa-check"></i> Confirmar</button><br>
          </form>
