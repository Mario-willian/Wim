...
$result_estoque = "SELECT * FROM contato";
...
$result_estoques = "SELECT * FROM contato limit $inicio, $quantidade_pg";
$resultado_estoques = mysqli_query($conn, $result_estoques);
...
<header>
    <div class="row">
        ...
        <div class="col-md-8">
            <center>
            <h3><b><i></i> Lista de Comentários</b></h3></center>
        </div>
...
<div class="row">
    ...
    <div class="col-md-6">
       ...
       <?php while ($rows_estoques = mysqli_fetch_assoc($resultado_estoques)){ ?>
                <tr>
                    <td><?php echo $rows_estoques['codigo'];?></td>
                    <td><?php echo $rows_estoques['nome'];?></td>
                    <td><?php echo $rows_estoques['email'];?></td>
                    <td><?php echo $rows_estoques['comentario'];?></td>
                </tr>
       <?php } ?>
