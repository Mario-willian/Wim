...
<nav class="navbar navbar-inverse">
  ...
  <center>
        ...
        <div class="col-md-8">
            <center>
            <h3><b><i class='fa fa-clock-o'></i> Usuários Pendentes</b></h3></center>
            <h5>Quantia total pendente: <strong><?php if ($row_estoques3['sum(quantia)'] == "") {
              echo "R$ 00.00";
            }else{
        ...
        ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="pendentes.php?codigo=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-success">Depositado</a>
                        <a href="pendentes.php?codigo2=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-warning">Invalido</a>
                    </td>
