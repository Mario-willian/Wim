...
$result_estoque = "SELECT * FROM troca where status = 'pendente'";
...
$result_estoques = "SELECT * FROM troca where status = 'pendente' limit $inicio, $quantidade_pg";
$resultado_estoques = mysqli_query($conn, $result_estoques);
...
<nav class="navbar navbar-inverse">
  ...
  <center>
        ...
        <div class="col-md-8">
            <center>
            <h3><b><i class='fa fa-clock-o'></i> Trocas Pendentes</b></h3></center>
        ...
        ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="trocaspendentes.php?codigo=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-success">Concluído</a>
                        <a href="trocaspendentes.php?codigo2=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-warning">Inválido</a>
                    </td>
