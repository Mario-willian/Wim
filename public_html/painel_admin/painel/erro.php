...
<nav class="navbar navbar-inverse">
  ...
  <center>
        ...
        <div class="col-md-8">
            <center>
            <h3><b><i class='fa fa-close'></i> Erro na Transferência</b></h3></center>
            <h5>Quantia total não tranferida: <strong><?php if ($row_estoques3['sum(quantia)'] == "") {
              echo "R$ 00.00";
            }else{
        ...
        ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="erro.php?codigo=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-success">Depositado</a>
                        <a href="erro.php?codigo3=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-danger">Pendente</a>
