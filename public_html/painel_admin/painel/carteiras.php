...
$result_estoque = "SELECT * FROM carteira";
...
$result_estoques = "SELECT * FROM carteira limit $inicio, $quantidade_pg";
$resultado_estoques = mysqli_query($conn, $result_estoques);
...
<header>
    <div class="row">
        ...
        <div class="col-md-8">
            <center>
            <h3><b><i></i> Lista das Carteiras</b></h3></center>
        </div>
    ...
    <div class="col-md-6">
       ...
       <?php while ($rows_estoques = mysqli_fetch_assoc($resultado_estoques)){ ?>
                <tr>
                    ...
                    <td>R$ <?php echo $rows_estoques['saldo'];?></td>
