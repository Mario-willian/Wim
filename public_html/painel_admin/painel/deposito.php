...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="deposito.php" method="get"><center>
            <h3><b><i></i> Inserir Valores</b></h3></center>
            <div class="form-group">
                <label for="valor">Valor a Adicionar</label>
                <b><input type="text" name="valor" maxlength="4" placeholder="Ex: R$2.00" class="form-control" required><br></b>
                <label for="usuario_cpf">CPF do Usuário</label>
                <b><input type="text" name="usuario_cpf" maxlength="17" placeholder="Ex: 000.000.000-00"  class="form-control" required><br></b>
            </div>

                <div class="row">
                    <div class="col-md-6 col-xs-6">
                        <br><button type="submit" class="btn btn-success btn-block" name="enviarvalor">Enviar</button><br>
