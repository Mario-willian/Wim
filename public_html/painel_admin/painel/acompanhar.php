...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="#" method="post"><center>
            <h3><b><i class='fa fa-eye fa-fw'></i> Alterar Acompanhar</b></h3></center>
            <div class="form-group">
                 <label for="descricao">Tempo para Liberamento do Saque</label>
                <b><input type="text" name="ultimaavaliacao" class="form-control" placeholder="Ex: Feb 28, 2019 15:37:25" required></b>
    </div>
