...
$result_estoque = "SELECT * FROM troca where status = 'invalido'";
...
$result_estoques = "SELECT * FROM troca where status = 'invalido' limit $inicio, $quantidade_pg";
$resultado_estoques = mysqli_query($conn, $result_estoques);
...
<nav class="navbar navbar-inverse">
  ...
  <center>
        ...
        <div class="col-md-8">
            <center>
            <h3><b><i class='fa fa-close'></i> Erro na Troca</b></h3></center>
        ...
        ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="trocaserro.php?codigo=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-success">Depositado</a>
                        <a href="trocaserro.php?codigo3=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-danger">Pendente</a>
