...
<nav class="navbar navbar-inverse">
  ...
  <center>
        ...
        <div class="col-md-8">
            <center>
            <h3><b><i class='fa fa-check'></i> Certificados Enviados</b></h3></center>
    ...
    <div class="col-md-10">
       ...
       <?php while ($rows_estoques = mysqli_fetch_assoc($resultado_estoques)){ ?>
                <tr>
                    ...
                    <td>
                        <a href="certificadosconcluidas.php?codigo2=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-warning">Invalido</a>
                        <a href="certificadosconcluidas.php?codigo3=<?php echo $rows_estoques['codigo']; ?>" class="btn btn-danger">Pendente</a>
                    </td>
