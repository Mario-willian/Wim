...
<section class="row-fluid">
  <div class="containerCentered"><section id="content">       <section id="headline">        <h1 class="accessAid">       <BR>  Termos e Condições para serviços da WIM</h1>        </section> <div class="ua_legalhub_div"> <h4>Estes Termos e Condições aplicam-se a usuários no Brasil. Para exibir contratos de um país ou região diferente, selecione uma das opções na lista abaixo.</h4><hr> <select id="legalhub"> <option value=""> Selecione sua localização </option> <option value= "termos.php"> Brasil (em português) </option>  </select> </div> <p> </p> <h3>Para todos os usuários<br /> </h3><div class="catWidget columnContainer nsb_12_12"> <div class="one column"><ul class="ua_legalhub_list"> <li><a title="Contrato do Usuário" href="contrato.php"><h5>Contrato do Usuário da WIM</a></li> <li><a title="Declaração de Privacidade" href="privacidade.php"><h5>Política de Privacidade</a></li> </ul></div> </h3> <h3><div class="two column nogutter"></div></div><h3> </h3> <h3>Informações adicionais</h3><div class="catWidget columnContainer nsb_12_12"> <div class="one column"><ul class="ua_legalhub_list"> <li><a title="Relatório de Infrações" href="politicainfracao.php"><h5>Política de Relatório de Infração</a></li> </ul></div><div class="two column nogutter"></div></div><h3> </h3> <h3>Atualizações dos contratos</h3><ul class="ua_legalhub_list"> <li><a title="Atualizações dos contratos" href="atualizacao.php"><h5>Atualizações dos contratos</a></li> </ul><p> </p> <h4>Estes contratos, políticas e avisos legais estabelecem os termos e condições relacionados a serviços específicos da WIM.</h4><hr></section>           </section>  </div>
</section>
